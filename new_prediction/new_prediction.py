...
# Load the data
Xtraintest = pd.read_csv(DATA_FOLDER + SYSTEM_SEP + "X_GPCRA17_Mold_PT.csv")
Xval = pd.read_csv(DATA_FOLDER + SYSTEM_SEP + "X_DNS_Mold_PT.csv")
ytraintest = pd.read_csv(DATA_FOLDER + SYSTEM_SEP + "y_GPCRA17_Mold_PT.csv")
yval = pd.read_csv(DATA_FOLDER + SYSTEM_SEP + "y_DNS_Mold_PT.csv")
...
filtered_features.to_csv(FEATURES_FOLDER + SYSTEM_SEP + "ProtTrans_Mold2_features.csv", index=False)  
...
gpcr_a17_maap = joblib.load(MODEL_FOLDER + SYSTEM_SEP + 'best_GPCRA17MAAP_meta_model_run_2.joblib')
...
predictions_df.to_csv("predictions_GPCRA17_MAAP.csv", index=False)
